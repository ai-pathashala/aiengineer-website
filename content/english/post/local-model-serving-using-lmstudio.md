...
![LM Studio RAG](/images/lmstudio-4.png)

To serve a model for API access, use the Developer tab in the sidebar.

![LM Studio model serving](/images/lmstudio-5.png)
